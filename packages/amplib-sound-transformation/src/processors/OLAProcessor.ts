...
export class OLAProcessor extends AudioWorkletProcessor {
  ...
  hopSize: number;
  nbOverlaps: number;
  inputBuffers: Array<Array<Float32Array>>;
  inputBuffersHead: Array<Array<Float32Array>>;
  inputBuffersToSend: Array<Array<Float32Array>>;
  outputBuffers: Array<Array<Float32Array>>;
  outputBuffersToRetrieve: Array<Array<Float32Array>>;
